...
echo ""
echo "Recommendations for user: U 2, Tablets filter"
echo ""
curl -H "Content-Type: application/json" -d '
{
    "user": "U 2",
...
echo ""
echo "Recommendations for user: U 2, Tablets boost"
echo ""
curl -H "Content-Type: application/json" -d '
{
    "user": "U 2",
...
echo ""
echo "Recommendations for user: U 2, Tablets excluded"
echo ""
curl -H "Content-Type: application/json" -d '
{
    "user": "U 2",
...
echo ""
echo "Recommendations for user: U 2, Tablets excluded, Estados Unidos Mexicanos boosted"
echo ""
curl -H "Content-Type: application/json" -d '
{
    "user": "U 2",
...
echo ""
echo "Recommendations for user: U 2, Tablets and Samsung excluded, Estados Unidos Mexicanos boosted, phones included"
echo ""
curl -H "Content-Type: application/json" -d '
{
    "user": "U 2",
...
echo ""
echo "Recommendations for user: U 2, Tablets and Samsung boosted, Estados Unidos Mexicanos excluded, phones included"
echo ""
curl -H "Content-Type: application/json" -d '
{
    "user": "U 2",
